...
function LogIn(props:LogProps):JSX.Element {
    ...
    const handleLogin = async () => {
        try {
            ...
            if (response.ok) {
                navigation.navigate('My Codes', { name: result.userId})
            }
            else {
                Alert.alert('credentials wrong')
            }
        }
        catch (e) {
            console.error('uh oh')
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.loginView}>
                ...
                <BigBlackButton title='Log In' action={handleLogin}/>
            </View>
        </View>   
   )
}
